...
ALTER TABLE group_permissions
  ADD CONSTRAINT FK_GROUPPERMISSIONS_GROUPS FOREIGN KEY (grp) REFERENCES grps (grp) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE user_groups
  ADD CONSTRAINT FK_USERGROUPS_GROUPS FOREIGN KEY (grp) REFERENCES grps (grp) ON DELETE CASCADE ON UPDATE CASCADE,
